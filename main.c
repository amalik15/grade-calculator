...
void Category(char input[], grade **root, char c[])
{
	...
	if the category already exists and will return to main without creating a new node.*/
	while (cur != NULL)
	{
	...
	thus it will creat a new one*/

	/*this block of code will look for the first space in the input string
